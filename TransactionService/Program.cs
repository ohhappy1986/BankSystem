...
using TransactionService.ClientProxies;
...
//Register BLLs.
builder.Services.AddScoped<ITransactionsBll, TransactionsBll>();

//Register Proxies.
builder.Services.AddScoped<IAccountServiceProxy, AccountServiceProxy>();
